  ...
  return (
    <div className='bg-white mx-2 mb-8 mt-4 rounded-md'>
      <div className='pb-8'>
          ...
          <img className='lg:h-80 h-62 w-3/5 mx-auto mt-4' src="https://i.ibb.co/mJCZ7PY/joinin.png" alt="joinin"></img>
          <div className='h-7 w-52 bg-cyan-800 text-center mx-auto text-white py-px rounded-full mt-4'>
            <h2>Details</h2>
          </div>
      </div>
    </div>
